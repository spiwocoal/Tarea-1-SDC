...
y se puede observar en la \autoref{fig:control-int-hibrido}, donde es importante
...
Simulamos entonces el sistema, y para este controlador, no logramos utilizar un
...
de estado. El método utilizado puede entonces verse en el \autoref{lst:problema-i-sims}.

Las gráficas obtenidas para este valor de $\nara{k_{c}}$ son aquellas de la
\autoref{fig:psi-int-disc} y \autoref{fig:estado-int-disc}.
