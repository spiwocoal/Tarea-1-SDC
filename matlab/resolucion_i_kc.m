...
a4= - 1.3895;
a3 = 0.8998;
a2 = (0.009*kc*ka*kst-1.0775) ;
a1 = (0.0058*kc*ka*kst+0.5673) ;
a0 = (-0.0038*kc*ka*kst);

A5= (a1 - a0 - a2 + a3 - a4 + 1);
A4=(5*a0 - 3*a1 + a2 + a3 - 3*a4 + 5);
A3=(2*a1 - 10*a0 + 2*a2 - 2*a3 - 2*a4 + 10);
A2= (10*a0 + 2*a1 - 2*a2 - 2*a3 + 2*a4 + 10) ;
A1= (a3 - 3*a1 - a2 - 5*a0 + 3*a4 + 5);
A0= (a0 + a1 + a2 + a3 + a4 + 1);
% obtencion b3
num_b_3= A4*A3 - A5*A2 ;
den_b_3= A4;
...
simp_b3=collect(b3,kc)
simp_b2=collect(b2,kc)
simp_b1=collect(b1,kc)
simp_b0=collect(b0,kc)
%obtención de posibles kc
kcb3=double(solve(simp_b3,kc))
kcb2=double(solve(simp_b2,kc))
